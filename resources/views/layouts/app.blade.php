...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="flex flex-wrap justify-center">
        <div class="flex w-full justify-between px-4 bg-purple-900 text-white">
            <a href="/" class="mx-3 py-4">Inicio</a>
            @auth
                <div class="py-4">
                    <span class="mx-3 font-semibold">Hola, {{ auth()->user()->name }} 👋</span>
                    <livewire:logout />
                </div>
            @endauth
            @guest
                <div class="py-4">
                    <a href="/login" class="mx-3">Entrar</a>
                    <a href="/register" class="mx-3">Registro</a>
                </div>
            @endguest
        </div>
